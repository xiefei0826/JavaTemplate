	...
	<td>
		<c:choose>
			<c:when test="${consumer.destinationQueue}">
				Queue <a href="browse.jsp?JMSDestination=<c:out value="><c:out value=" ${consumer.destinationName}" /></a>
			</c:when>
			<c:when test="${consumer.destinationTopic}">
				Topic <a href="send.jsp?JMSDestination=<c:out value="><c:out value=" ${consumer.destinationName}" /></a>
			</c:when>
			<c:otherwise>
